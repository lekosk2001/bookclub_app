...
import { FETCH_BOARD_COMMENT, UPDATE_BOARD_COMMENT } from '../board_comment_list/BoardCommentList_queries';
import { IMutation, IMutationCreateBoardCommentArgs, IMutationUpdateBoardCommentArgs } from '@/common/types/generated/types';
